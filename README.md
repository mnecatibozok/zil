...
- Ses dosyalarının yüklü olup olmadığını gösterir (Zil, Marş, Saygı, Deprem sesleri).
...
- **Zil Sonrası Anons Ayarları**: Zil çaldıktan hemen sonra otomatik olarak hangi anons dosyasının çalacağını belirleyin. Öğretmen zili, öğrenci zili, toplanma zili ve son zil için ayrı ayrı anons dosyası seçilebilir. *— Anons yok —* seçiliyse sadece zil çalar, anons çalmaz.
