...
[zil-baslat.bat]
       ...
       │
       └──▶ [Google Chrome] ──▶ http://localhost:PORT/zil-programi-v1.html
                   │
...
├── zil-programi-v1.html    ← Ana kontrol paneli (Chrome'da açılır)
...
│   ├── anons0.mp3          ← Toplanma anonsu
│   ├── anons1.mp3          ← Öğretmen girişi anonsu
│   ├── anons2.mp3          ← Öğrenci girişi anonsu
│   ├── anons3.mp3          ← Son zil anonsu
│   └── anons4.mp3          ← Ekstra anons
│
...
3. Birkaç saniye içinde Chrome tarayıcı tam ekran açılır ve zil programı görünür.
...
- Ses dosyalarının yüklü olup olmadığını gösterir.
...
|-----------|----------|------------------|
| `zil.mp3` | Tenefüs zili | Her ders başı/sonu |
...
| `anons0.mp3` | Toplanma anonsu | Zil sonrası |
| `anons1.mp3` | Öğretmen girişi anonsu | Zil sonrası |
| `anons2.mp3` | Öğrenci girişi anonsu | Zil sonrası |
| `anons3.mp3` | Son zil anonsu | Tenefüs bitişi |
| `anons_ogrenci.mp3` | Öğrenci zili anonsu | Öğrenci girişi |

**Kendi Ses Dosyanızı Eklemek:**
- MP3 formatında olmalı.
- Dosyayı `zilsesleri/` klasörüne kopyalayın.
- Programı yeniden başlatın (veya sayfayı F5 ile yenileyin).
- **Ses** sekmesinde dosya otomatik görünür.
