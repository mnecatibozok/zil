> Güncelleme tarihi: 15 Ağustos 2026
...
- **Otomatik Kapatma**: Belirlediğiniz saatte bilgisayarın güvenli şekilde kapanmasını sağlar (önce anfi kapatma sinyali gönderilir, birkaç saniye sonra sunucu üzerinden `shutdown` komutu çalışır). Yalnızca program yerel sunucu üzerinden (`zil-baslat.bat`) çalışırken kullanılabilir.
