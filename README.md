...
> 💡 **Varsayılan ses (fallback):** `zil_tenefus.mp3`, `zil_ogrenci.mp3`, `zil_ogretmen.mp3`, `zil_toplanma.mp3` dosyalarından biri henüz eklenmediyse, o zil tipi **sessiz kalmaz** — otomatik olarak genel `zil.mp3` çalar. Ayarlar panelinde bu durumdaki dosya adı turuncu renkte gösterilir (özel dosya yüklendiğinde yeşile döner). Yani kurulumdan hemen sonra, hiçbir özel dosya eklemeden de tüm ziller `zil.mp3` ile çalışır; istediğiniz zaman 📁 ile birini özelleştirebilirsiniz.
